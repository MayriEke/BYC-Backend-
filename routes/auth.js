...
//     // generate auth token
//     const token = jwt.sign({name: user.name, _id: user._id, isAdmin: user.isAdmin},config.get('jwtPrivateKey'));
//     res.json({ success: true, token, name: user.name, _id: user._id, isAdmin: user.isAdmin });
// });
